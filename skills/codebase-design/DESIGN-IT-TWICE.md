...
Include both [SKILL.md](SKILL.md) vocabulary and the project's domain vocabulary (its glossary or
domain docs, where they exist) in the brief so each sub-agent names things consistently with the
