...
<img alt="release v0.49.54" src="https://img.shields.io/badge/release-v0.49.54-8b5cf6?style=flat-square">
...
v0.49.54 uses schema `0.26.0`. The JSON block in `docs/agentic/STATE.md` accepts only `version`,
...
v0.49.54 dispatches every role through one call:
