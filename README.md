...
<p>
  <img alt="release v0.48.0" src="https://img.shields.io/badge/release-v0.48.0-8b5cf6?style=flat-square">
...
v0.48.0 dispatches every role through one call:
...
`docs/agentic/STATE.md`. v0.48.0 uses schema `0.26.0`. Breaking config-shape changes bump the minor
