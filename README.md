...
<p>
  <img alt="release v0.47.1" src="https://img.shields.io/badge/release-v0.47.1-8b5cf6?style=flat-square">
...
v0.47.1 dispatches every role through one call:
...
`docs/agentic/STATE.md`. v0.47.1 uses schema `0.26.0`. Breaking config-shape changes bump the minor
